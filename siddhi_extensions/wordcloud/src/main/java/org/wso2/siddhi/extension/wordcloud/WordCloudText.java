...
public class WordCloudText extends StreamProcessor {
    ...
    private final static String[] STOPWORD = {"via", "wow", "10", "b4",
            "gt", "get", "gets", "come", "go", "ben", "carson", "rubio", "bencarson", "one", "two", "new", "man", "rt",
            ...
            "own", "same", "so", "than", "too", "very", "say", "says", "said", "shall", "rick", "santorum", "ricksantorum",
